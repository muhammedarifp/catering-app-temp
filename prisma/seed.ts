...
async function main() {
  ...
  const dishes = [
    // Welcome Drink
    {
      ...
      dishType: 'LIVE', labourCost: 0,
      priceUnit: 'per plate', pricePerPlate: 0, estimatedCostPerPlate: 0, sellingPricePerPlate: 85, isVeg: true,
      ingredients: [],
    },
    {
